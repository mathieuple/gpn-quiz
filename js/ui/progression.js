...
import {renderLeaderboardFull} from '../leaderboard/leaderboard-ui.js';
...
export function progression(root,ctx) {
  ...
  root.innerHTML=`<div class="stack">
    ...
    <section id="leaderboard" class="card leaderboard-card"><div><p class="eyebrow">MEILLEUR COMBO GLOBAL</p><h2>🏆 Classement</h2></div><div id="leaderboard-full" aria-live="polite"></div></section>
  ...
  renderLeaderboardFull(root.querySelector('#leaderboard-full'),ctx);
}
